...
## Frontend
A React-based interface now demonstrates voice analysis and provides visual feedback. The page background shifts colors based on the detected emotional state and an avatar emoji reacts to stress levels. The frontend is served by a small Node script (`server.js`).
